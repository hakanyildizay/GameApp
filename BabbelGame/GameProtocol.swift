...
protocol GameViewProtocol: AnyObject{
    ...
    func answerResult(isCorrect: Bool)  //When user select either true/false, then it should get notified if he is correct or wrong
    func numberOfAttempts(for answer: Bool, count: Int) //Number of attemps for Correct / Wrong
}
